...
"""
@author: Alex Wang
@contact: awang0725@outlook.com
@prject: learningPython
@file: Lines.py
@time: 2018-01-29  下午11:05
...
class Line(object):
    ...
    def __eq__(self,ell):
        ...
        n = self.normal_vector
        return basepoint_difference.orthogonal_to(n)
    ...
    def intersection(self,ell):
        try:
            ...
            return Vector([x,y]).times_scalar(one_over_demon)
